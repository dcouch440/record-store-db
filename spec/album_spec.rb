...
describe '#Album' do
  ...
  describe('#save') do
    it("saves an album") do
      album = Album.new({:name => "A Love Supreme", :id => nil}) # nil added as second argument
      album.save()
      album2 = Album.new({:name => "Help!", :id => nil}) # nil added as second argument
      album2.save()
  ...
  describe('.clear') do
    it("clears all albums") do
      album = Album.new({:name => "A Love Supreme", :id => nil})
      album.save()
      album2 = Album.new({:name => "Help!", :id => nil})
      album2.save()
      Album.clear()
      expect(Album.all).to(eq([]))
    end
